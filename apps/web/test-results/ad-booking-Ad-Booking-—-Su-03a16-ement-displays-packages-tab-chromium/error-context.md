...
- Name: ad-booking.spec.ts >> Ad Booking — Superadmin Management >> displays packages tab
- Location: tests\e2e\ad-booking.spec.ts:83:7
...
Locator: getByText('Katalog Paket Iklan', { exact: true })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Katalog Paket Iklan', { exact: true })

```

```yaml
- complementary:
  - link "BK BeritaKarya Admin Center":
    - /url: /pusat/dashboard
    - text: BK
    - heading "BeritaKarya" [level=2]
    - paragraph: Admin Center
  - button "Portal Aktif"
  - paragraph: Pusat (Nasional)
  - navigation:
    - paragraph: Utama
    - link "Ringkasan":
      - /url: /pusat/dashboard
    - link "Post":
      - /url: /pusat/dashboard/articles
    - link "Media":
      - /url: /pusat/dashboard/media
    - link "Profil Saya":
      - /url: /pusat/dashboard/profile
    - paragraph: Editorial
    - link "Antrian Review":
      - /url: /pusat/dashboard/review
    - link "Antrian KYC":
      - /url: /pusat/dashboard/review/kyc
    - link "Kalender":
      - /url: /pusat/dashboard/calendar
    - link "Kategori":
      - /url: /pusat/dashboard/categories
    - link "Iklan & Banner":
      - /url: /pusat/dashboard/ads
    - link "Komentar":
      - /url: /pusat/dashboard/comments
    - paragraph: Administrasi
    - link "Monitor Tim":
      - /url: /pusat/dashboard/team
    - link "Pengguna":
      - /url: /pusat/dashboard/users
    - link "Undangan":
      - /url: /pusat/dashboard/invitations
    - link "Audit Log":
      - /url: /pusat/dashboard/audit
    - link "Pengaturan":
      - /url: /pusat/dashboard/settings
    - paragraph: Superadmin
    - link "Manajemen Situs":
      - /url: /pusat/dashboard/admin
    - link "AI Dashboard":
      - /url: /pusat/dashboard/admin/ai-usage
  - text: TS Test Superadmin Pimred (CEO) / Admin IT
  - button "Keluar Sistem"
- main:
  - button
  - textbox "Cari artikel..."
  - button
  - button
  - link "Portal":
    - /url: /pusat
  - heading "Portal Iklan & Monetisasi" [level=1]
  - paragraph:
    - text: "Cabang Regional:"
    - strong: pusat
    - text: superadmin
  - button "Refresh Data"
  - button "Slot Iklan Regional Aktif"
  - button "Katalog Paket Iklan (CRUD)"
  - button "Antrean Validasi Booking"
  - heading "Katalog Paket Tarif Iklan Dinamis" [level=3]
  - button "Tambah Paket Baru"
  - heading "Ketentuan & Panduan Portal Iklan BeritaKarya" [level=4]
  - list:
    - listitem: Penyelarasan iklan regional berjalan otomatis seketika setelah Superadmin Pusat menyetujui pengajuan kampanye pengiklan.
    - listitem: Untuk mengoptimalkan kecepatan muat halaman portal wilayah, semua file spanduk iklan disarankan dikompresi ke format **WebP** dengan batas maksimum ukuran file sebesar **200 KB**.
    - listitem: Administrasi keuangan di portal wilayah dikendalikan sepenuhnya melalui sistem transfer satu pintu rekening terpusat.
- alert
```
