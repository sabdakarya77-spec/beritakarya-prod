...
export const AD_SLOT_DEFINITIONS: AdSlotDefinition[] = [
  {
    ...
    publicSize: '800 x 200 px (Desktop) / 320 x 80 px (Mobile)',
  ...
  },
  {
    ...
    placementPages: ['homepage'],
    publicSize: '300 x 100 px (Desktop) / 210 x 70 px (Mobile)',
    ...
    publicHighlights: [
      'Ukuran: 300 x 100 px (Desktop) / 210 x 70 px (Mobile) — Rasio 3:1',
      'Format: Gambar statis, GIF',
      'Penempatan: Feed homepage posisi atas',
    ],
    publicMockup: '300 x 100 px',
  },
  {
    id: 'HOME_FEED_2',
    name: 'Feed Bawah',
    ...
    placementPages: ['homepage'],
    publicSize: '210 x 70 px (Desktop) / 180 x 60 px (Mobile)',
    ...
    publicHighlights: [
      'Ukuran: 210 x 70 px (Desktop) / 180 x 60 px (Mobile) — Rasio 3:1',
      'Format: Gambar statis, GIF',
      'Penempatan: Feed homepage posisi bawah',
    ],
    publicMockup: '210 x 70 px',
  },
  {
    id: 'ARTICLE_TOP',
    name: 'Artikel Atas',
