...
export const AD_SLOT_DEFINITIONS: AdSlotDefinition[] = [
  ...
  },
  {
    id: 'ARTICLE_TOP',
    name: 'Artikel Atas',
    size: '728 x 90 px / Mobile: 300 x 250 px',
    desc: 'Muncul di halaman artikel setelah paragraf ke-3.',
    placementPages: ['artikel'],
    publicSize: '728 x 90 px (Desktop) / 300 x 250 px (Mobile)',
  ...
  },
  {
    ...
    placementPages: ['artikel'],
    publicSize: '970 x 90 px (Desktop) / 728 x 90 px (Tablet) / 320 x 50 px (Mobile)',
    ...
    publicHighlights: [
      'Ukuran: 970 x 90 px (Desktop) / 320 x 50 px (Mobile)',
      'Format: Gambar statis, GIF',
