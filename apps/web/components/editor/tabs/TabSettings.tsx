  ...
  return (
    <div className="p-4 space-y-6 animate-fade-in">
      ...
      <div className="space-y-2">
        ...
        {contentType === 'photo_journalism' && (
          <p className="text-[9px] text-panel-text-muted">Min. 1 foto, min. 15 kata narasi • Kategori: Foto Jurnalistik • Badge: Eksklusif</p>
        )}
        {contentType === 'video_exclusive' && (
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center rounded-lg border border-panel-border bg-panel-surface overflow-hidden focus-within:border-panel-accent transition-all">
          <span className="px-3 py-2 text-xs font-bold text-white bg-panel-surface/50 border-r border-panel-border select-none shrink-0">
            BeritaKarya/
          </span>
          <input
            type="text"
