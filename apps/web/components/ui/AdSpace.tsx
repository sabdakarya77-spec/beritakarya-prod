...
export default function AdSpace({
  ...
  const styles: Record<AdSlotId, string> = {
    ...
    ARTICLE_TOP:    "w-full max-w-[728px] mx-auto h-[250px] min-h-[250px] md:h-[90px] md:min-h-[90px] mb-8",
    ARTICLE_MIDDLE: "w-full h-[250px] min-h-[250px] mb-12",
    ARTICLE_BOTTOM: "w-full max-w-[970px] mx-auto h-[50px] min-h-[50px] md:h-[90px] md:min-h-[90px] mb-6",
  };
