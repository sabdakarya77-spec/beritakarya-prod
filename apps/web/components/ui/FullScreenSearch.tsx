    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] bg-[#F8FAFC]/95 dark:bg-[#020617]/95 backdrop-blur-2xl flex flex-col px-6 py-8 md:px-16 md:py-16 transition-colors duration-300"
        >
          {/* Header Controls */}
