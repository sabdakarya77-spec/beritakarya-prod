      ...
      <div className="relative h-[350px] overflow-hidden rounded-2xl sm:h-[400px] md:h-[450px] lg:h-[560px]">
        ...
        <div className={cn(
          ...
          <Link href={`/${site}/artikel/${active.slug}`}>
            <h1 className="mb-3 max-w-3xl line-clamp-2 font-sans text-xl font-extrabold leading-tight tracking-tight text-white transition-colors hover:text-white/85 md:line-clamp-3 md:text-2xl lg:text-3xl xl:text-4xl">
              {active.title}
            </h1>
          </Link>
