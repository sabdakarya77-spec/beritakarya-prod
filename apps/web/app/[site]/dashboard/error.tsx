...
export default function DashboardError({
  ...
  const dashboardHref = site ? `/${site}/dashboard` : '/'

  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 px-4 py-20 dark:bg-slate-950">
      <div
        aria-hidden
      ...
      <div className="relative z-10 w-full max-w-md text-center">
        ...
        <p className="mx-auto mt-3 max-w-sm text-sm leading-7 text-slate-600 dark:text-slate-400">
          Terjadi kesalahan saat memuat bagian dashboard. Perubahan yang belum tersimpan kemungkinan tidak akan hilang dan dapat dicoba ulang.
        </p>
